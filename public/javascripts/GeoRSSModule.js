        ...
        if (i != null) {
            switch (i.tagName.toLowerCase()) {
                ...
                case "gml:polygon":
                    ...
                    if (exR.length > 0) {
                        //TODO
                        //Currently no support for inner polygons or polygons with holes. Revisit if support is added for complex shapes.
                        //Draw first exterior ring     
                        _allCoords.concat(exR);
                        s = new Microsoft.Maps.Polygon(exR, _options.polygonOptions);
                    }
                    break;
                    break;
                default:
